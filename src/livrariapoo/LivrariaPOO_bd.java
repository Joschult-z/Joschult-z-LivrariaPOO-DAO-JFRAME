...
public class LivrariaPOO_bd {
    ...
    public static void listarEditora() {
        EditoraServicos editoraS = ServicosFactory.getEditoraServicos();
        for (Editora edi : editoraS.getEditoraDAO()) {
            System.out.println("----");
    ...
    private static void cadastrarLivro() {
        ...
        if (livroS.buscaLivroISBN(isbn).getIsbn() != null) {
            ...
            // idlivro nao precisa alterar para o serviço do livro pois o id sera gerido pelo banco
    ...
    private static void listarLivro() {
        ...
        LivroServicos livroS = ServicosFactory.getLivroServicos();
        if (!livroS.listarLivrosDAO().isEmpty()) {
            for (Livro livro : livroS.listarLivrosDAO()) {
                /*System.out.println("---\nISBN:\t\t" + livro.getIsbn());
    ...
    private static void vendaLivro() {
        VendaLivroServicos vlS = ServicosFactory.getVendaLivroServicos();
        ClienteServicos clienteS = ServicosFactory.getClienteServicos();
        LivroServicos livroS = ServicosFactory.getLivroServicos();
